...
public class Cluster implements Warnable {
	...
	private final Map<AbstractStation, gqserver.core.analysis.Event> assignedEvents;
	 ...
	 */
	public Map<AbstractStation, gqserver.core.analysis.Event> getAssignedEvents() {
	...
	private boolean checkForUpdates() {
		int upd = 0;
		for (gqserver.core.analysis.Event e : getAssignedEvents().values()) {
